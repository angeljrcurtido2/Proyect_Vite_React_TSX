...
const styleButton = "mt-8 mb-8 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition";
                    ...
                    <div className="md:col-span-2 flex flex-col items-start gap-2">
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                            {selectedActividades.map((act) => (
                                <span key={act.idactividad} className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-md flex items-center gap-1">
                                    {act.descripcion}
                                    <button
                                        type="button"
                                        onClick={() => handleRemoveActividad(act.idactividad)}
